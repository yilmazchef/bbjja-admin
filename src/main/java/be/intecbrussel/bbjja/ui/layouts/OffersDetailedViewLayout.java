...
@SpringComponent
@Tag ( "offers-detailed-view-layout" )
public class OffersDetailedViewLayout extends VerticalLayout {
	...
	public OffersDetailedViewLayout( final AuthenticatedUser user,
		...
		final var newFrameVideo = new LocalVideoLayout( "./videos/maps.mp4" );
		add( newFrameVideo );
