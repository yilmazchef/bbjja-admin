...
@PageTitle ( "BBJA | Subscribers" )
@Route ( value = "subscribers", layout = MainLayout.class )
@PermitAll
public class SubscribersQuickView extends ViewFrame implements LocaleChangeObserver {

	private final AuthenticatedUser authenticatedUser;
	private final SubscriberService subscriberService;


	public SubscribersQuickView( final AuthenticatedUser authenticatedUser, final SubscriberService subscriberService ) {

		this.authenticatedUser = authenticatedUser;
		this.subscriberService = subscriberService;

		setId( "subscribers-quick" );
