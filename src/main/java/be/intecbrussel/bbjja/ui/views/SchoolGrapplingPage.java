...
@Tag ( "school-grappling-page" )
public class SchoolGrapplingPage extends VerticalLayout {

	@Autowired
	public SchoolGrapplingPage( final AuthenticatedUser authenticatedUser, final GrapplingService grapplingService ) {

		setId( "school-grappling-page".concat( String.valueOf( Instant.now().getNano() ) ) );
